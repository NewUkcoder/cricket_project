...
<head>
    ...
    <title>Cricket Scorecard Admin - First Innings Bowling</title>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php 
                    if (empty($bowling_first)) {
                        echo "<tr><td colspan='6' class='text-center'>Add bowling records for first innings</td></tr>";
                    } else {
                        try {
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap justify-content-center gap-2">
                                            ...
                                            <form action="<?php echo base_url(); ?>/ScorecardController/delete_bowling_record" method="POST" style="display:inline;">
                                                ...
                                                <input type="hidden" name="bowling_order" value="<?php echo htmlspecialchars($bowl->bowling_order ?? ''); ?>">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editModal.addEventListener('show.bs.modal', function(event) {
                ...
                const fields = {
                    'id': 'player-id', // Updated to match data-player-id
