...
<body>
    ...
    <div class="container">
        ...
        <form action="<?= base_url('TeamController/insert_captain') ?>" method="POST" id="playerForm">
            <div class="form-group">
                <label for="player">For Tennis Ball:</label>
            ...
            <!-- Hidden inputs for both player name, ID, team_id, ball_type -->
            ...
            <input type="hidden" id="ball_type" name="ball_type" value="tennis_ball"> <!-- Fixed ball type to tennis_ball -->
    ...
    <script>
        ...
        const selectBallType = document.getElementById("ball_type");  // The hidden input for tennis_ball
